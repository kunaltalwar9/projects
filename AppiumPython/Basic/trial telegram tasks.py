...
#                       "https://goo.gl/maps/kGcWWA3G67GiXYhG8","https://goo.gl/maps/uaei9CeoGMCixSK68","https://goo.gl/maps/xsUgo3dpJHezAPPP6"]
all_restaurants_list = ["https://goo.gl/maps/MeESwWu5VjMFrhdi9", "https://goo.gl/maps/JHwaP4mUqRQmryBZA"]
...
for i in range(0,len(all_restaurants_list)):
    ...
    try:
        ...
        driver.find_element(By.XPATH,
                            '(//android.widget.ImageView[@resource-id="com.google.android.apps.maps:id/star5"])[4]').click()
'''
    # if driver.find_element(By.XPATH,'(//android.widget.ImageView[@resource-id="com.google.android.apps.maps:id/star5"])[2]').is_displayed():
    if driver.find_element(By.XPATH,'').is_displayed(): # Failing here
        continue
    '''
    if driver.find_element(By.XPATH,'(//android.widget.ImageView[@resource-id="com.google.android.apps.maps:id/star5"])[2]').click() throws
        driver.find_element(By.XPATH,
                            '(//android.widget.ImageView[@resource-id="com.google.android.apps.maps:id/star5"])[2]').click()
        driver.find_element(By.XPATH,
                            '(//android.widget.ImageView[@resource-id="com.google.android.apps.maps:id/star5"])[3]').click()
